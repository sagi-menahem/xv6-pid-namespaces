// File: syscall.c	Name:Sagi Menahem	ID:208645937
#include "types.h"
#include "defs.h"
#include "param.h"
#include "memlayout.h"
...
extern int sys_cps137(void); 	// Declaration of the cps137 system call handler function.
...
[SYS_cps137] sys_cps137,	// Maps the cps137 system call number to its handler function.
};
